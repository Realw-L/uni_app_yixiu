			...
			<view class="grace-form">
				<form @submit="formSubmit">
					<view class="grace-items">
						...
						<input type="text" class="input" name="name" maxlength="5"></input>
					</view>
					<view class="grace-items">
						<view class="grace-label">联系电话</view>
						<input type="text" class="input" name="mobile"></input>
					</view>
					<view class="grace-items">
...
export default {
	...
	methods:{
		addData(req){
			util.POST('user/team_member/add', req, function(data) {
				console.log('user/team_member/add' + JSON.stringify(data));
		...
		formSubmit : function(e){
			...
			if(checkRes){
				...
				//save 
				formData['team_id'] = _self.team_id;
				formData['area'] = _self.cityPickerValueDefault1.join(',');
				_self.addData(formData);
