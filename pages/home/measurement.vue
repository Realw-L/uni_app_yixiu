<template>
	<view class="uni-common-pb">
		<view class="uni-card">
			...
			<view class="uni-list-cell-divider uni-flex" hover-class="uni-list-cell-hover" style="justify-content: space-between;">
				<text style="color: #000000; display: flex; flex-direction: row;">现场联系人：</text>
			...
			<view>
				<text style="display: flex; justify-content: flex-end;">+86</text>
			...
			<view class="uni-list-cell-divider" hover-class="uni-list-cell-hover" style="  height: 50px;">
				<text style="font-size: 10upx;">详细地址：</text>
				<textarea style="font-size: 15px;" placeholder="如道路、门牌号、小区、楼栋号、单元室等" maxlength="25" />
				</view>	
		</view>
		...
		<view style="margin-top: 2px;" class="uni-card">
			<view class="uni-list-cell-divider"  style="font-size: 15px;">
				<text>对师傅接单的要求</text>
			</view>
			<view class="uni-grid-9" style="background: none; border: none;">
						<view class="uni-grid-9-item menu_item"  style="height: 150upx; " >
