				...
				<view class="grace-list-items">
					...
					<view class="grace-list-body">
						<view class="grace-list-title">
							<text class="grace-list-title-text">曹师傅</text>
						</view>
						<view class="grace-list-body-desc">性别：男 38岁</view>
						<view style="display: flex; flex-direction: row;">
						<view><text>综合评分：</text></view>
						<view style="width:350upx; margin-top: -20upx;">		
						<graceStar :starnum="currentStarNum1" :cantap="false"></graceStar>
									</view>
									</view>
						<view class="grace-list-body-desc">实名认证：已认证</view>
					</view>					
						<view style="margin-right: 10upx;margin-top: 100upx;" @tap="goDetailPage('master_order')">
