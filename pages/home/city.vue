<template >
	<view >
		<view class="search-box"  style="margin-top:40upx;">
		...
		bindAZ: function(e) {
		  ...
		  citySelected: function(e) {
			var cityNameTemp = e.currentTarget.dataset.cityname;
				...
				uni.setStorageSync('city', this.currentCity)
				this.getCityInfo(this.currentCity)				
		  },
			
			//get city center
			getCityInfo: function(city_name) {
				
				var self = this
				util.GET(
				  'city/find?city='+city_name,
				  {},
				  function (data) {
				    if (data) {
						if(data.longitude){
							uni.setStorageSync('city_center', data.longitude+','+data.latitude) 
						}
